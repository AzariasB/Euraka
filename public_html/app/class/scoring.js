...
class Scoring
{
    ...
    endLevel()
    {
         ...
         */
        var affichage = []; // Variable dans laquelle on vas stocker chaque point d'affichage
        var self = this;
        ...
        var bonusMunition = config.scoring.PER_MUNITIONS * this.game.character.getEnergy();
        this.levelScore += bonusMunition;
        var kik = this.game.character.hasKikette();
        if ( kik )
        {
        ...
        affichage.push(
                ...
                },
                {
                    ...
                    valeurScore : kik * config.scoring.KIKETTE_BONUS
                })
